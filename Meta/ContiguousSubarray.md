...
More formally, count the number of contiguous subarrays $numbers [i..j]$ ($i\leq j$) for which there are $2 * k$ elements (with **pairwise distinct** indices $i \leq i_1, j_1
i_2, j_2, ...., i_k, j_k) with each pair having same value  - $numbers [i_1] = numbers [j_1], numbers [i_2]
= numbers[j_2], ..., numbers[i_k] = numbers[j_k]$
...
- numbers [1..4] = [1, 0, 1, 0] with numbers [1] = 1 = numbers [3] and
numbers [2]
= numbers [4]
о numbers [0..4] = [0, 1, 0, 1, 0] with
numbers [0] 0 = numbers [2] 3
numbers [1] = 1 = numbers [3], and
numbers [2] = 0 = numbers [4]
